...
#print(remove_special_characters(EV["documents"][m]))
...
print("\n")
print("The answer using my own retriever and passing the retrieve chains to the template context:\n")
...
## With load_qa_chain
print("This answer when using load_qa_chain:\n")
